...
# # setup for custom auth login when use authenticate()
# AUTHENTICATION_BACKENDS = (
#     'django.contrib.auth.backends.ModelBackend',
#     # 'account.views.CustomModelBackend',
# )
...
SITE_ID = 1
SESSION_COOKIE_NAME = 'account_sso_sessionid'
...
SECRET_KEY = '*g%jgkyyiuy9@=at0w-w7m^ru7py*^9163o61_6)kg+1*nl@-$'
